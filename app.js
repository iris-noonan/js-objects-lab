...
*/
game.party.push(pokemon[0], pokemon[5], pokemon[62])
...
let pokemonNames = pokemonParty.join(', ');

console.log('Exercise 8 result: ', pokemonNames);
...
pokemon.forEach((poke) => {
    if (poke.starter === true) {
        pokemonStarter.push(poke.name)
    }
});
let starterPokemonNames = pokemonStarter.join(', ');

console.log('Exercise 9 result: ', starterPokemonNames);
...
game.catchPokemon = function (pokemonObj) {
    ...
    game.items[1].quantity = pokeballs - 1
}
